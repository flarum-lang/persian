...
```
یا از طریق پنل مدیریت در بخش Extension Manager در فیلد Install a new extension نام افزونه lkacom/persian را وارد کنید و کلید Proceed را بزنید تا عملیات نصب انجام شود.
