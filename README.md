<h1 align="center" style="display: flex; align-items: center; justify-content: center;"><img src="icon.svg" alt="پرچم ایران" style="margin-left: 10px; height: 30px;" />
  افزونه زبان فارسی <a href="https://flarum.org" target="_blank" style="text-decoration: none; color: inherit;">Flarum</a>
...
این افزونه، ترجمه‌ی کامل زبان فارسی برای انجمن‌ساز **Flarum** است. با نصب این افزونه
، رابط کاربری و پیام‌های سیستم به زبان فارسی تغییر خواهند کرد.این افزونه فارسی فورکی از افزونه رسمی سایت فلاروم است اما در بخش های ترجمه مشکلات و اشتباهات ترجمه ویرایش شده و برای استفاده فارسی زبان ها بهینه شده است.

---

## 🎯 ویژگی‌ها
- ترجمه تمامی بخش‌های رابط کاربری
...
## آخرین وضعیت ترجمه برای هسته Flarum
...
## وضعیت ترجمه برای افزونه‌های رسمی
...
### پیش‌نیازها
- **Flarum** نسخه 1.0 یا بالاتر
- PHP نسخه 8.1 یا جدیدتر
- Composer

### مراحل نصب

 ابتدا افزونه را با استفاده از Composer نصب کنید:

   ```console
   composer require lkacom/persian
```
یا از طریق پنل مدیریت به Extension Manager مراجعه کنید و در بخش "نصب افزونه جدید" نام افزونه lkacom/persian را وارد کنید و دکمه "نصب" را بزنید تا عملیات نصب به صورت خوکار انجام شود.
...
پس از هر بار نصب یا بروز رسانی از دستور زیر برای حذف کش استفاده کنید:
